  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.body}>
        <Text style={styles.title}>Utilities ready for integration</Text>
        <Text style={styles.subtitle}>Bill payments, airtime, gift cards, and subscriptions will live here.</Text>
      </View>
    </SafeAreaView>
  );
}
