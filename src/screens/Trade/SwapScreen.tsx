  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.body}>
        <Text style={styles.title}>Routing not enabled</Text>
        <Text style={styles.subtitle}>Swaps will appear once the routing engine is connected to your liquidity providers.</Text>
      </View>
    </SafeAreaView>
  );
}
